...
export default {
        ...
        remoteConfig: [
          {
            ...
            options: [
              {
                label: "默认",
                value: "https://raw.githubusercontent.com/Repcz/Tool/X/Clash/Meta/Online_Full_Auto.ini"
              },
              {
                label: "默认（自动测速）",
  ...
  methods: {
    ...
    tanchuang() {
      this.$alert(`<div style="text-align:center;font-size:15px"><strong><span style="font-size:20px;color:red">记得选择默认后端为worker自建</span></strong></br><strong><span style="font-size:20px">哈哈哈哈：</span><span><a href="https://t.me/ron_834" target="_blank" style="color:red;, {
